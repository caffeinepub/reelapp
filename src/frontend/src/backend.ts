...
export class Backend implements backendInterface {
    ...
    async deleteVideoPost(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllVideos(): Promise<Array<PersistentVideoPost>> {
        if (this.processError) {
            try {
    ...
    async getComments(arg0: string): Promise<Array<PersistentComment>> {
        if (this.processError) {
            try {
    ...
    async getTrendingVideos(): Promise<Array<PersistentVideoPost>> {
        if (this.processError) {
            try {
    ...
    async getVideo(arg0: string): Promise<PersistentVideoPost | null> {
        if (this.processError) {
            try {
    ...
    async getVideosByUser(arg0: Principal): Promise<Array<PersistentVideoPost>> {
        if (this.processError) {
            try {
    ...
    async hasUserLikedVideo(arg0: string, arg1: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasUserLikedVideo(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PersistentVideoPost_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PersistentVideoPost): Promise<PersistentVideoPost> {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PersistentUserProfile]): PersistentUserProfile | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_PersistentVideoPost]): Promise<PersistentVideoPost | null> {
    return value.length === 0 ? null : await from_candid_PersistentVideoPost_n12(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        views: value.views,
        videoAssetId: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.videoAssetId),
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PersistentVideoPost>): Promise<Array<PersistentVideoPost>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PersistentVideoPost_n12(_uploadFile, _downloadFile, x)));
}
